...
class Program
{
	...
	static void CalculatorStart(Calculator calculator)
	{
		...
		float convertin3 = float.Parse(input1);
		float convertin4 = float.Parse(input2);
		...
		if (chose == "3")
		{
			...
			Console.WriteLine("Result Int " + convertin1 + " / " + convertin2 + " : " + result);
			float result1 = calculator.Divide(convertin3, convertin4);
			Console.WriteLine("Result Float " + convertin3 + " / " + convertin4 + " : " + result1);
